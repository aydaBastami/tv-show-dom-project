...
let divForsearch = document.querySelector(".myHeader");
...
const myfunc = async () => {
  try {
    let apiAddrese = await axios.get(
    ...
    for (let i = 0; i < apiAddrese.data.length; i++) {
      ...
      headerForDiv.setAttribute("class", "headerForDiv");
    ...
    let defaultPage = document.querySelector(".homeTag")
